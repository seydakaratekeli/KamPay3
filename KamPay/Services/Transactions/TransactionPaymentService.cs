      ...
      IPaymentProviderFactory paymentProviderFactory) // âœ… EKLEME
        ...
        public async Task<ServiceResult<bool>> SetPaymentMethodAsCashAsync(string transactionId)
        {
            try
            {
                ...
                return ServiceResult<bool>.SuccessResult(true, "Ã–deme yÃ¶ntemi elden (nakit) olarak ayarlandÄ±.");
            }
            catch (Exception ex)
            {
                return ServiceResult<bool>.FailureResult("Ã–deme yÃ¶ntemi gÃ¼ncellenemedi.", ex.Message);
            }
        }
