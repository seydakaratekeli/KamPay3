...
namespace KamPay.Views
{
    public partial class RegisterPage : ContentPage
    {
        ...
        public RegisterPage(RegisterViewModel vm)
        {
            ...
            // ?? Artık manuel doğrulama yok, PropertyChanged dinlemeye gerek yok
        }
        ...
        {
            // Circle 1: Saat yönünde sürekli dönüş
            ...
            // Circle 2: Saat yönü tersine sürekli dönüş
        ...
        {
            base.OnDisappearing();
            // Sayfadan çıkıldığında animasyonları durdur
