...
{
    /// <summary>
    /// Android için optimize edilmiş görsel yükleme handler'ı
    ...
    public class OptimizedImageHandler : ImageHandler
    {
        ...
        private void LoadImageWithGlide(ImageView imageView)
        {
            ...
            if (VirtualView.Source is UriImageSource uriSource)
            {
                ...
                KamPay.Helpers.AppLogger.DebugLog($"? Glide: Görsel yüklendi - {uriSource.Uri}");
            }
            ...
            else if (VirtualView.Source is FileImageSource fileSource)
            {
                ...
                KamPay.Helpers.AppLogger.DebugLog($"? Glide: Yerel görsel yüklendi - {fileSource.File}");
            }
